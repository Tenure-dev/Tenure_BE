...
@Schema(description = "Purchase offer cancel response")
public record PurchaseOfferCancelResponse(

        @Schema(description = "Purchase offer ID", example = "123")
        Long offerId,

        @Schema(description = "Purchase offer status", example = "CANCELED")
    ...
    public static PurchaseOfferCancelResponse from(PurchaseOffer offer, LocalDateTime serverTime) {
        return new PurchaseOfferCancelResponse(
                offer.getId(),
                offer.getStatus(),
